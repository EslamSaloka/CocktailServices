...
<head>
    ...
    <title> - نسيت كلمة المرور  {{ env('APP_NAME') }} </title>
                ...
                <div class="row justify-content-center no-gutter position-relative">
                    <div class="col-lg-2 col-md-4">
                        <div class="login-box-left  white-bg">
                            ...
                            <ul class="nav">
                                <li class="active"><a href="#"> <i class="fa fa-lock"></i> نسيت كلمة المرور</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-4 theme-bg">
                        <div class="login-box pos-r text-white login-box-theme">
                            ...
                            <br><br>
                            <p class="text-white" style="line-height:1.9">يمكنك الان إستعادة كلمة المرور الخاصة بحسابك عبر ادخال رقم جوالك المسجل لدينا</p>
                    ...
                    <div class="col-md-5">
                        <div class="login-box pb-50 clearfix white-bg">
                            <h3 class="mb-30">ادخل رقم جوالك</h3>
                            <form action="{{ route('forgetPassword') }}" method="post">
                                <div class="section-field mb-20">
                                    <label class="mb-10" for="name">رقم الجوال</label>
                                    <input id="name" class="web form-control" type="number" placeholder="05XXXXXXXX" name="phone">
                                    @error('phone')
