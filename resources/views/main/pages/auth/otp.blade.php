...
<head>
    ...
    <title> - كود التحقق  {{ env('APP_NAME') }} </title>
                ...
                <div class="row justify-content-center no-gutter position-relative">
                    <div class="col-lg-2 col-md-4">
                        <div class="login-box-left  white-bg">
                            ...
                            <ul class="nav">
                                <li class="active"><a href="#"> <i class="fa fa-sign-in"></i>كود التحقق</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-4 theme-bg">
                        <div class="login-box pos-r text-white login-box-theme">
                            ...
                            <br><br>
                            <p class="text-white" style="line-height:1.9">هذه الخطوة هامة جدا للتحقق من رقم جوالك عبر كتابة كود التحقق المرسل لك</p>
                    ...
                    <div class="col-md-5">
                        <div class="login-box pb-50 clearfix white-bg">
                            <h3 class="mb-30">كود التحقق</h3>
                            <form action="{{ route('otp') }}" method="post">
                                <div class="section-field mb-20">
                                    <label class="mb-10" for="name">كود التحقق</label>
                                    <input id="name" class="web form-control" type="number" placeholder="XXXX" name="otp">
                                    @error('otp')
                            ...
                            <div class="section-field">
                                <div class="remember-checkbox mb-30" style="direction:rtl;">
                                    <br>
                                    <form action="{{ route('re-send',\Auth::user()->phone) }}" method="get">
                                        <div class="row">
                                            <div class="col-md-8">
