        ...
        <div class="card custom-card">
            ...
            @endif
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @include('admin.component.form_fields.input', [
                                ...
                                'type' => 'text',
                                'required' => true,
                                'value' => old('name') ??(isset($employer) ? $employer->name : null)
                            ])
                        </div>
                    </div>
                </div>
                <div class="card-footer mb-1">
                    ...
                    <a href="{{ route('admin.employers.index')}}" class="btn btn-danger">@lang('Cancel')</a>
                </div>
            </form>
        </div>
    </div>
...
@push('scripts')
    <script type="text/javascript" src="{{ asset('vendor/jsvalidation/js/jsvalidation.js')}}"></script>
        {!! JsValidator::formRequest('App\Http\Requests\Dashboard\Employers\CreateOrUpdateRequest') !!}
@endpush
