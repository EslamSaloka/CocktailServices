...
<div class="row row-sm">
    <div class="col-lg-12 col-md-12">
        <div class="card custom-card">
            @if(isset($page))
                <form action="{{ route('admin.terms.update', [$page->id, 'page' => request()->query('page')]) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @else
            ...
            @endif
                ...
                <div class="card-footer mb-1">
                    ...
                    <a href="{{ route('admin.terms.index')}}" class="btn btn-danger">@lang('Cancel')</a>
                </div>
            </form>
        </div>
    </div>
