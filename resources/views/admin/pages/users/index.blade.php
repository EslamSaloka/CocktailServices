            ...
            <div class="tab-menu-heading">
                <div class="tabs-menu ">
                    ...
                    <ul class="nav panel-tabs">
                        <li class=""><a href="#tab11" class="active" data-bs-toggle="tab"> @lang('غير فعال')</a></li>
                        <li><a href="#tab12" data-bs-toggle="tab" class="">@lang('فعال')</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-lg-20p"><span>@lang('الحاله')</span></th>
...
@include('admin.component.modals.filter', [
    'fields' => [
        [
            'name' => 'name',
            'label' => 'البحث بالإسم او رقم الجوال',
            'type' => 'text'
        ],
        [
            'name' => 'role_id',
